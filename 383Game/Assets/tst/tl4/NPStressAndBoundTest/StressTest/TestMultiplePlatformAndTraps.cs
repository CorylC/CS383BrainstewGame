...
public class NewTestScript : MonoBehaviour //  Inherit from MonoBehaviour
{
    ...
    public void LoadScene()
    {
        ...
        #if UNITY_EDITOR
        platformPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/prefab/tl4/MovingPlatformPrefab.prefab");
        trapPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/prefab/tl4/TrapPrefab.prefab");
        #endif
