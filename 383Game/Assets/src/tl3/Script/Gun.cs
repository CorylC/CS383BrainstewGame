...
public class Gun : MonoBehaviour
{
    ...
    //Bullet prefab after implementing powerup
    ...
    public void Fire()
    {
        // Choose which bullet to spawn depending on upgrade status
        GameObject bulletToSpawn = upgraded ? upgradedBulletPrefab : bulletPrefab;
